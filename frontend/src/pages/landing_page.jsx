...
const languages = [
  { title: "Frontend Stack", description: "HTML, CSS, JavaScript, React", bg: "bg-[#0F1110]", border: "border-[#66BB6A]" },
  { title: "Backend Systems", description: "Node.js, Express, Python, Java", bg: "bg-[#0F1110]", border: "border-[#66BB6A]" },
  { title: "Mobile Dev", description: "React Native, Flutter", bg: "bg-[#0F1110]", border: "border-[#FBC02D]" },
  { title: "Database Systems", description: "SQL, MongoDB, PostgreSQL", bg: "bg-[#0F1110]", border: "border-[#A5D6A7]" },
];
...
const LandingPage = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-between bg-[#0F1110] text-[#FFFFFF] font-outfit grid-bg overflow-x-hidden">
      {/* Top Banner Status */}
      <div className="w-full bg-[#0F1110] border-b border-[#2E3A33] py-2.5 px-8 flex items-center justify-between text-sm text-[#9CA3AF] z-20 font-jetbrains">
        ...
        <div className="hidden sm:flex items-center gap-6 text-xs">
          ...
          <span className="text-[#D7D7D7]">WIDESCREEN_RESPONSIVE</span>
        </div>
      </div>
      ...
      <div className="w-full max-w-[1800px] mx-auto px-6 sm:px-12 lg:px-16 py-12 z-10 flex flex-col items-center">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 bg-[#0F1110] border border-[#66BB6A] px-5 py-1.5 font-pixelify">
        ...
        <AnimatePresence>
          {showContent && (
            ...
            >
              ...
              <div className="bytecode-card p-10 sm:p-16 shadow-2xl relative border border-[#2E3A33]">
                ...
                <p className="text-lg sm:text-xl text-[#D7D7D7] max-w-4xl mx-auto leading-relaxed mb-10 font-outfit">
              ...
              <div className="space-y-8">
                <div className="flex items-center justify-between border-b border-[#2E3A33] pb-4">
                  ...
                  <span className="text-sm text-[#9CA3AF] font-mono">[PLATFORM_FEATURES]</span>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
                  {whyByteCode.map((item, i) => (
                    ...
                    >
                      ...
                      <p className="text-base text-[#D7D7D7] leading-relaxed">{item.description}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-center justify-between border-b border-[#2E3A33] pb-4">
                  ...
                  <span className="text-sm text-[#9CA3AF] font-mono">[STACK_MATRICES]</span>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
                  {languages.map((item, i) => (
                    ...
                    >
                      ...
                      <p className="text-base text-[#D7D7D7] font-mono">{item.description}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="space-y-8 mb-16">
                <div className="flex items-center justify-between border-b border-[#2E3A33] pb-4">
                  ...
                  <span className="text-sm text-[#9CA3AF] font-mono">[DEV_SUITE]</span>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
                  {features.map((item, i) => (
                    ...
                    >
                      ...
                      <p className="text-base text-[#D7D7D7] leading-relaxed font-outfit">{item.description}</p>
                    </div>
                  ))}
                </div>
              </div>
