...
const Dashboard = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#2F3437] text-white font-inter p-10 max-w-[1800px] mx-auto space-y-8">
  ...
  return (
    <div className="min-h-screen bg-[#2F3437] text-[#F5F7F5] font-inter flex flex-col justify-between grid-bg">
      ...
      <div className="w-full max-w-[1800px] mx-auto px-6 sm:px-12 lg:px-16 py-10">
        ...
        <div className="bytecode-card p-8 sm:p-10 mb-8 border border-[#626A6E] relative shadow-2xl">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <img
                  src={logo}
                  alt="ByteCode Logo"
                  className="w-12 h-12 object-contain filter drop-shadow-[0_0_12px_rgba(102,187,106,0.3)]"
                />
              ...
              <p className="text-base text-[#D5DBD6] font-inter max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full lg:w-auto">
              <div className="relative flex-1 sm:w-70">
                ...
                />
                {/* <IconSearch size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#AAB2AD]" /> */}
              </div>
          ...
          {STATS_BAR.map((stat, idx) => (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="font-geist-pixel text-xs text-[#AAB2AD] tracking-wider">
                  {stat.label}
                </span>
                {stat.icon}
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {activeCourse ? (
              <div className="bg-[#3A4044] p-8 border border-[#66BB6A] relative">
                <div className="flex items-center justify-between mb-4 pb-3 border-b border-[#626A6E]">
                  ...
                  <span className="text-xs font-mono text-[#AAB2AD]">
              ...
              <div className="bytecode-card p-10 text-center border border-[#626A6E]">
                ...
                <p className="text-sm text-[#D5DBD6] max-w-md mx-auto mb-6">
            ...
            <div className="bytecode-card p-8">
              <div className="flex justify-between items-center mb-6 pb-3 border-b border-[#626A6E]">
              ...
              <div className="space-y-4">
                {filteredCourses.length === 0 ? (
                  <p className="text-sm text-[#AAB2AD] font-mono text-center py-6">
                ...
                {activities.length === 0 ? (
                  <div className="flex items-center gap-4 p-4 bg-[#3A4044] border border-[#626A6E]">
                    ...
                    <div className="flex-1">
                      ...
                      <span className="text-[#D5DBD6]">Start exercises or lessons to build your timeline</span>
                    </div>
                    <span className="text-[#66BB6A] font-bold">+5 XP</span>
                    <span className="text-[#AAB2AD]">today</span>
                  </div>
                ) : (
                  activities.map((act, index) => (
                    <div key={index} className="flex items-center gap-4 p-4 bg-[#3A4044] border border-[#626A6E]">
                      ...
                      <div className="flex-1">
                        ...
                        <span className="text-[#D5DBD6]">{act.description}</span>
                      </div>
                      {act.xpEarned > 0 && (
                        <span className="text-[#66BB6A] font-bold">+{act.xpEarned} XP</span>
                      )}
                      <span className="text-[#AAB2AD]">{formatActivityTime(act.createdAt)}</span>
                    </div>
                  ))
                )}
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bytecode-card p-6 border border-[#626A6E]">
              <div className="flex items-center justify-between mb-4 pb-3 border-b border-[#626A6E]">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-baseline font-mono">
                  <span className="text-2xl font-geist-pixel text-white">{todayXP} <span className="text-xs text-[#AAB2AD]">/ {dailyGoalXP} XP</span></span>
                ...
                <p className="text-xs text-[#D5DBD6] font-inter">
                  {dailyProgress >= 100 ? (
            ...
            <div className="bytecode-card p-6 border border-[#626A6E]">
              <div className="flex items-center justify-between mb-6 pb-3 border-b border-[#626A6E]">
                <h3 className="font-geist-pixel text-lg text-white flex items-center gap-2">
                  <IconTrendingUp size={18} className="text-[#66BB6A]" />
                  WEEKLY_XP_MATRIX
                </h3>
                <span className="text-xs font-mono text-[#AAB2AD]">LIVE_DATA</span>
              </div>
              ...
              <div className="flex items-end justify-between h-40 pt-4 gap-2">
                {WEEKLY_XP.map((bar, idx) => (
                  <div key={idx} className="flex flex-col items-center gap-2 flex-1 h-full justify-end">
                    ...
                    <span className="text-[11px] font-mono text-[#AAB2AD]">{bar.day}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bytecode-card p-6 border border-[#626A6E]">
              <h3 className="font-geist-pixel text-lg text-white mb-4 pb-3 border-b border-[#626A6E]">
                QUICK_ACTIONS
              </h3>
              ...
              <div className="grid grid-cols-2 gap-3">
                {QUICK_ACTIONS.map((act, i) => (
                  ...
                  >
                    ...
                    <span className="text-[10px] text-[#AAB2AD] font-mono">
                      {act.desc}
                    </span>
                  </Link>
                ))}
