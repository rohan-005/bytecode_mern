...
const Profile = () => {
  ...
  const updateProfile = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://bytecode-qsew.onrender.com/api/auth/profile', {
        method: 'PUT',
        headers: {
  ...
  const changePassword = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://bytecode-qsew.onrender.com/api/auth/change-password', {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-purple-900/20 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="bg-gradient-to-r from-purple-900/50 to-blue-900/50 rounded-2xl p-8 border border-gray-700">
                ...
                <form onSubmit={updateProfile} className="space-y-6">
                  ...
                  <div className="flex items-center gap-4 pt-4">
                    <button
                      type="submit"
                      disabled={loading}
                      className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-500 shadow-2xl hover:shadow-purple-500/20 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                    >
                      {loading ? (
