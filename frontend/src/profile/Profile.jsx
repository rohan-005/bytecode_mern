...
const Profile = () => {
  ...
  const updateProfile = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://bytecode-qsew.onrender.com/auth/profile', {
        method: 'PUT',
        headers: {
  ...
  const changePassword = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://bytecode-qsew.onrender.com/auth/change-password', {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
